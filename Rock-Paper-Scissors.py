...
# Create labels to display user's choice, computer's choice, result, and score
...
# Create buttons for user to choose Rock, Paper, or Scissors
button_rock = tk.Button(window, text='Rock', command=lambda: play_round('Rock'), bg="#add8e6", font=('Arial', 12), width=10)
button_rock.grid(row=4, column=0, padx=10, pady=10)

button_paper = tk.Button(window, text='Paper', command=lambda: play_round('Paper'), bg="#ffcccb", font=('Arial', 12), width=10)
button_paper.grid(row=4, column=1, padx=10, pady=10)

button_scissors = tk.Button(window, text='Scissors', command=lambda: play_round('Scissors'), bg="#d3ffce", font=('Arial', 12), width=10)
button_scissors.grid(row=5, column=0, padx=10, pady=10)

# Create a button to reset the game
button_reset = tk.Button(window, text='Reset Game', command=reset_game, bg="#f0e68c", font=('Arial', 12), width=10, bd=5)
