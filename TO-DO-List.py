...
class Task:
    ...
    def __str__(self):
        ...
        return f"{self.description} ({due_date_str}) [{status}]"
    ...
    def update_task(self):
        ...
        if selected_index:
            ...
            new_description = simpledialog.askstring(
                "Update Task", "New description:", initialvalue=task.description
            )
            new_due_date = simpledialog.askstring(
                "Update Task", "New due date (optional):", initialvalue=task.due_date
            )
            if new_description:
